...
const ALL_TABS: {
...
}[] = [
  {
    ...
    adminOnly: false,
    icon: (a) => (
      <svg width="22" height="22" viewBox="0 0 24 24" fill={a ? "#C81E3A" : "none"} stroke={a ? "#C81E3A" : "#94A3B8"} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    adminOnly: false,
    icon: (a) => (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={a ? "#F59E0B" : "#94A3B8"} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
        <rect x="2" y="6" width="20" height="14" rx="3"/>
        <path d="M2 10h20"/>
        <circle cx="7" cy="15" r="1" fill={a ? "#F59E0B" : "#94A3B8"} stroke="none"/>
        <path d="M11 15h6"/>
      </svg>
    ),
  },
  {
    ...
    adminOnly: false,
    icon: (a) => (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={a ? "#10B981" : "#94A3B8"} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    adminOnly: false,
    icon: (a) => (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={a ? "#8B5CF6" : "#94A3B8"} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    adminOnly: true,
    icon: (a) => (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={a ? "#EC4899" : "#94A3B8"} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export default function BottomNav({ active, onChange, member, pendingMemberCount = 0 }: BottomNavProps) {
  const isAdmin = member?.type === "admin" || member?.notes === "__superadmin__";
